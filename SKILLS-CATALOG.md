...
| `helio-cli` | Helio CLI v1.4 (+ live sync vs CLI v0.6.0) | ✅ v0.6.1 |
...
| Skill | Source doc(s) | Status |
|---|---|---|
| `helio-creating-test` | Creating a Helio Test v0.1 | ✅ v0.2.3 (new in v0.6.0; owns the UI-only boundary checklist) |
| `helio-patterns` | Helio Test Patterns v0.2 (scrubbed) + Test Pattern Playbook v0.1 (merged) | ✅ v0.4.1 |
| `helio-asset-to-test` | From Asset To Test v0.1 | ✅ v0.2.1 |
