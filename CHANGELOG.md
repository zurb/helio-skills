...
Caught by Benjamin reading the CLI's own error text against our docs — a good argument for the tool being the source of truth over any doc, which is the same lesson as [helio-cli#18](https://github.com/zurb/helio-cli/issues/18).
...
Zurb-internal project names (Signal Blitz, O2 series, R5 Campaign, Test and Learn, Helio Services, Homepage Baselines) were left intact — they're Zurb's own work, not customer engagements.
...
- `helio-ux-metrics` — Real score patterns per metric: the hunting-apparel store 12% Success, O2 145 V5 92/87/38, the athletic-apparel homepage 87 Desirability + 14 NPS, the B2B data-platform homepage 80 Comprehension with jargon tail
...
- `helio-reading-report` — Four worked synthesis patterns with full one-sentence signals: O2 145 V5 divergence, the hunting-apparel store 12% red flag, the athletic-apparel homepage 87/14 gap, the B2B data-platform homepage stated-vs-behavioral
