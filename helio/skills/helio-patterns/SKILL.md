...
Read `reference.md` for the full pattern catalog with concrete examples (the athletic-apparel homepage, the hunting-apparel store, the press-room site, the investment-platform, the veteran careers landing page, 144/145 series), the 30-second reading routine, and the construction decision tree.
