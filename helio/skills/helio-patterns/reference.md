...
|---|---|---|
| Asset count | 1 | 3–7 |
| Examples in this batch | the athletic-apparel homepage, the B2B data-platform homepage, the investment-platform, R3/R5 series, all 145 variants | the hunting-apparel store (3 screens), the press-room site (7), the banking-app prototype, 144 series |
...
<!-- DERIVED FROM: 14upcMSPKz5GEtcwPBQMnUFvoDZHS8qoH-A7wlE4Rqzg — Test Pattern Playbook v0.1 -->
