...
The same-metric-twice section drops its reorder caveat: helio-cli v0.8.0 makes repeated instances reorderable from a fresh session, so uuids no longer have to be captured from the create response.
