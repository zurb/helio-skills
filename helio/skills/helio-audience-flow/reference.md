...
**R5 Campaign Full V1:** Three audiences run side by side — Consumers / SMB Owners / Strangers. The compare-across-segments cut is the test's headline output, not the aggregate.
