...
<!-- DERIVED FROM: 1Ut1W_IquHicra7su2JA4324iUc6aH_9QMOnHUpGSHh8 — Reading a Helio Report v0.2 -->
...
- Success Poor (under 30) → affordance invisible (the hunting-apparel store Q5 12% pattern)
...
<!-- DERIVED FROM: 1sdfXae1FwVPy12hKAX2TdzADHRdMCVBDbuJfkRmDCfM — From Helio Test to Glare Signal v0.2 -->
...
### O2 145 V5 — cross-metric divergence
...
> *Signal:* On the O2 145 PDP V5 variant, US shoppers engaged with the page (Engagement Very Good) and reacted positively to it (Desirability Good), but planned next-action intent dropped to 38 — the page is attractive but not persuasive. The next iteration should pressure-test CTA placement and value-prop framing closer to the fold.

### The hunting-apparel PLP Q5 — Success at 12%

The textbook red flag for an invisible affordance.

- **Numbers:** Q5 Success metric = 12% (Very Poor) on a targeted Click Test for the PLP filter UI
- **Read:** Primary-hotspot click rate this low means the filter is essentially invisible. Without the Success metric on this question, the broken filter would have been hidden in raw click data.

> *Signal:* On the hunting-apparel PLP, the filter affordance scored Success 12% (Very Poor) for hunting-apparel shoppers — the filter UI is effectively invisible from the PLP. The next iteration needs to raise the filter to a primary visual element, not a secondary control.

### An athletic-apparel DTC homepage — Desirability/NPS gap

People like it but won't recommend it.

- **Numbers:** Desirability 87 (Good) with positive descriptors dominant (Helpful 73%, Innovative 69%) · NPS 14 (Average)
- **Read:** Strong positive emotional response without a corresponding share moment. The hero positions a single athletic-apparel SKU; no community indicators, no referral hook.

> *Signal:* On the athletic-apparel homepage, athletic-apparel shoppers reacted positively (Desirability Good) but NPS landed at 14 — there's no clear share moment built into the page. The next test should explore whether a referral incentive, a community indicator, or a shareable badge moves NPS without dropping Desirability.

### A B2B data-platform homepage — stated-vs-behavioral mismatch

What people say vs. what people do.

- **Numbers:** Q5 stated next-action: "Explore the Platform" at 35% · Q1 actual first-click concentrated on the Gartner Magic Quadrant badge
- **Read:** Stated intent and behavioral data point in different directions. Behavior wins — the Gartner proof is doing more work than the platform pitch.

> *Signal:* On the B2B data-platform homepage, US enterprise data leaders said they'd "Explore the Platform" (35%) but their actual first-click went to the Gartner badge — the analyst proof is doing more work than the platform pitch. The next iteration should test promoting the Gartner-led narrative to the hero.
