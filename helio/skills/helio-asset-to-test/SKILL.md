...
Read `reference.md` for the full seven-step walkthrough, the worked Dual-Offer example, the pre-launch checklist, and what the workflow doesn't yet cover (hotspots and branching are UI-only; image asset upload is CLI-native since helio-cli v0.1.1).
