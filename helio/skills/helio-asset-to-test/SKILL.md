...
Read `reference.md` for the full seven-step walkthrough, the worked Dual-Offer example, the pre-launch checklist, and what the workflow doesn't yet cover (asset upload, hotspots, branching — all UI-only today).
